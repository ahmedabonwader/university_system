...
class BachelorDetails(models.AbstractModel):
    _name = 'report.ums.print_bachelor_details_english_computer'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        college.registrar_english_name from ums_student as std join ums_college as college ON college.id = 
        std.college_id join ums_program as program ON program.id = std.program join ums_nationality as nation ON 
        nation.id = std.nationality_id and std.program IS NOT NULL and std.nationality_id IS NOT NULL and std.id = %s 
        """) % (
